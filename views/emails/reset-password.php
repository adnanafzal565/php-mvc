                        ...
                        <table class="status" bgcolor="#fffeea" cellspacing="0">
                          <tr>
                            <td class="status-cell">
                              Hey <b>{{ name }}</b>, We received a reset password request for your account. Kindly click the following link to reset your password: <br />
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">If you did not initiate any reset password request, you can ignore this email.</div>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Thanks so much,</p>
                              <p class="body-signature">{{ APP_NAME }}</p>
                            </td>
                          </tr>
                        </table>
                      </td>
